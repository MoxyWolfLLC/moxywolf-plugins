...
**Why it matters:** A Stripe refund appears as a negative transaction in the
settlement report. If you treat it as an unmatched outflow, you'll flag a
legitimate refund as a problem.

### ✗ Bad

> Flagged: Stripe outflow of –$89.00 on March 18 has no matching QB deposit.
...
## Gotcha: Comparing gross Stripe amount to net QB deposit

**Why it matters:** QuickBooks often records the net bank deposit (after Stripe
fees), but Stripe's transaction report shows the gross sale amount. Comparing
gross to net will always show a discrepancy equal to the fee.

### ✗ Bad

> Discrepancy: Stripe settlement $500.00, QB deposit $484.80 — delta $15.20.
> Flagged as reconciliation error.

The $15.20 is Stripe's 3.04% processing fee. This is expected and correct.

### ✓ Good

Use the **net payout** field from the Stripe settlement report
