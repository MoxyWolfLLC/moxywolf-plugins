...
description: >
  ...
  Stripe (/Stripe) settlements, flags uncategorized transactions,
...
Connect QuickBooks and at least one payment processor (Stripe),
...
Fetch settlement reports from Stripe — whichever are connected —
...
See [reference/stripe-settlements.md](reference/stripe-settlements.md) for settlement
report field mappings (Stripe).
...
- [reference/stripe-settlements.md](reference/stripe-settlements.md) — settlement
  report structure for Stripe
