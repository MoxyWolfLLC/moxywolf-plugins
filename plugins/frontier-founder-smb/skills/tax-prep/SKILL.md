...
1. Pull contractor/vendor payments from all connected sources: QuickBooks, Stripe.
...
5. Deliver the 1099-NEC candidate list with missing W-9 action items and the Stripe 1099-K overlap note.
