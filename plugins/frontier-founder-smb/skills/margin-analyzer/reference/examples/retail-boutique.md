...
**Connectors:** QuickBooks (costs), Stripe (online sales)
...
- **Stripe:** 14 months of transaction history (online sales only; in-store via Stripe separately)
...
- This example shows graceful handling of mixed data sources (Stripe online + Stripe in-store noted as limitation)
