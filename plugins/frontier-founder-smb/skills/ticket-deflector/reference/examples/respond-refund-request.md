# Example: Refund request — Stripe transaction found
...
## Step 7 — Send + Clarify note

Reply sent via Gmail.

Clarify note logged on Sarah M.'s contact:
> "Ticket Deflector — 2026-04-23: Customer reported damaged product. Full refund of $64.00 issued via Stripe (PP-3847-XXXX). Reply sent via email."

---

## Step 8 — Report

> Reply sent to Sarah M. · Refund of $64.00 issued (PP-3847-XXXX) · Clarify note logged.
