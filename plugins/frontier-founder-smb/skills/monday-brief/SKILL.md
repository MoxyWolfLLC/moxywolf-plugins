...
2. **Sales trend** — Stripe last 7 days vs. prior 7 days, % change, top SKU
3. **Pipeline** — Clarify deals moved, deals stalled (>14 days no activity), new inbound leads
...
If a connector is missing, note it in the brief ("Stripe not connected — sales trend skipped") rather than failing.
