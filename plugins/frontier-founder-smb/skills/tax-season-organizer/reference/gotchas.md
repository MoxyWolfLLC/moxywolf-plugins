...
## Stripe / Stripe 1099-K overlap

**BAD:** Instruct the user to file 1099-NECs for all contractors paid via Stripe.

**GOOD:** Flag the overlap and defer to the accountant.
> "Contractors paid via Stripe may already receive a 1099-K from those
