...
**1099-K note:** Stripe issues its own 1099-K to any recipient who receives ≥ $600
in goods & services payments. Flag this in output — the accountant determines whether
the business must also issue a 1099-NEC or can rely on Stripe's 1099-K.
...
**1099-K note:** Same as Stripe — Stripe issues 1099-K to contractors above the
...
2. Export a transaction history from Stripe (Activity → Download → CSV)
...
- Stripe: `Name`, `Type`, `Amount`, `Date`, `Transaction ID`
