...
- QuickBooks and Stripe are the primary, tested paths
...
3. **Location multiplicity** — QuickBooks and Stripe have simpler single-account models; Stripe requires user to pick a location

## How to implement

1. Obtain a Stripe sandbox/test account
2. Write scenarios for single-location and multi-location merchants
3. Add `reference/stripe-orders-example.md` with worked example
