...
Worked scenario for the call path — calendar event has three attendees, one of them isn't in Clarify yet.
...
- Sarah Lin is an existing Clarify contact on the "Acme Q2 Expansion" deal
- Ben Rivera is NOT in Clarify
...
> *"Ben Rivera (ben.rivera@acme.com) isn't in Clarify. Creating the contact and associating to the Acme Q2 Expansion deal."*
