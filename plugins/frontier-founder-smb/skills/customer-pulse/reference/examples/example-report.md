...
> "Where is my order? The tracking hasn't updated in 5 days." — [Clarify]

**2. Refund process too slow** (8 signals)
> "I filed a dispute because I never got a response to my refund request." — [Stripe]
> "It's been two weeks since I asked for a refund. Still waiting." — [Gmail]
> "Your return policy says 5 days but it's been 12." — [Clarify]
...
> "Would not buy again — quality is not what I expected for the price." — [Clarify]
...
## Example: Stripe rate-limited run

**Trigger used:** "Customer pulse for last 30 days"

### Sources pulled
- Stripe disputes: rate-limited — not included
- Clarify tickets: 7
- Gmail threads: 11
- Intercom conversations: 4
- Pasted reviews: 3

*(Report continues normally with available sources. Stripe note appears only in Sources — no error message in the body.)*
