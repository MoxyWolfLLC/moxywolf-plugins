...
**claude.ai/design tier:** Teams (no Enterprise)  
**Clarify tier:** Marketing Hub Professional  
...
## Stage 2: claude.ai/design asset generation (Pro/Teams path)

**Template selection exchange:**

```
Claude: I found 3 square-post templates in your claude.ai/design library:
...
Claude: Got it. I'll use "Boutique Stripe - Cream" for all feed posts.
        ...
        the product photos and text in claude.ai/design, then come back so I can export.
```

*[Designs created; owner fills in claude.ai/design; returns design IDs]*
...
```
Your campaign is staged in Clarify:
...
any post in Clarify before it goes out. Anything to change before we're done?
```

---

## Email content example (text-only — no claude.ai/design)

Email rows skip claude.ai/design entirely. Claude writes the email subject, preheader,
...
**Stage 3 output (inline, no claude.ai/design involved):**
