...
description: Must be used before any github-repo-analyzer skill or command so independently installed plugins still obey the MoxyWolf project, repository, and company-memory contract.
---
