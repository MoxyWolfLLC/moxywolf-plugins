...
description: Must be used before any product-orchestrator skill or command so independently installed plugins still obey the MoxyWolf project, repository, and company-memory contract.
---
