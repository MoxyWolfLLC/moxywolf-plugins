...
| `pricing-research` (skill) | generate | Pricing/market research synthesis (local artifact). Claim-bearing figures carry source + date (Test 3). Paid Actor runs require bounded inputs and user approval. |
