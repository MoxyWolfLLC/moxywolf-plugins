...
description: Must be used before any board-deck skill or command so independently installed plugins still obey the MoxyWolf project, repository, and company-memory contract.
---
