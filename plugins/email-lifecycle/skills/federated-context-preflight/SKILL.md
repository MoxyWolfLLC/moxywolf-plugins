...
description: Must be used before any email-lifecycle skill or command so independently installed plugins still obey the MoxyWolf project, repository, and company-memory contract.
---
