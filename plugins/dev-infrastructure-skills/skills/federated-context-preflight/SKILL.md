...
description: Must be used before any dev-infrastructure-skills skill or command so independently installed plugins still obey the MoxyWolf project, repository, and company-memory contract.
---
