...
description: Must be used before any obsidian-skills skill or command so independently installed plugins still obey the MoxyWolf project, repository, and company-memory contract.
---
