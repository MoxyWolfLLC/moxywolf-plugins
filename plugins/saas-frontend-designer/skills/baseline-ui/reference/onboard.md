> Modified by MoxyWolf LLC (2026-09-22) from impeccable v4.3.1 at `e0881d2` (Apache-2.0, (c) 2025 Paul Bakaus): the closing hand-off points at this plugin's `/polish`. See the plugin `NOTICE`.
