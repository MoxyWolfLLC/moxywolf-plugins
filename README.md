...
│   ├── 4d-blog-engine/             All commands prefixed /blog-* — init, voice, start, delegate, describe, discern, diligence, pipeline, publish, linkedin, status — base doc → 4-phase pipeline → blog + LinkedIn pair with Release Owner Gate
