...
Adding this marketplace on any Mac gives that machine all 23 plugins in one shot, with updates flowing from `main` whenever someone pushes a fix.
...
├── .claude-plugin/
│   └── marketplace.json                ← catalog (23 plugins) — source of truth for versions
├── README.md                            ← this file
├── plugins/                             ← 22 MoxyWolf-owned plugins
...
2. Paste:
   ...
   ```
3. Click **Sync**. The 23 plugins appear in the marketplace list.
